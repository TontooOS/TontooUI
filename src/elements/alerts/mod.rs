...
/// Card width in logical px (compact: half the original 420).
pub const ALERT_WIDTH: f32 = 210.0;
/// Card corner radius in logical px.
pub const ALERT_RADIUS: f32 = 12.0;
/// Inner padding in logical px.
pub const ALERT_PAD: f32 = 12.0;
/// Title size in logical px (semibold).
pub const ALERT_TITLE_SIZE: f32 = 8.5;
/// Message size in logical px (regular).
pub const ALERT_MESSAGE_SIZE: f32 = 7.5;
/// Gap between title and message in logical px.
pub const ALERT_TITLE_GAP: f32 = 4.0;
/// Gap between message and buttons in logical px.
pub const ALERT_MESSAGE_GAP: f32 = 10.0;
/// Action button height in logical px.
pub const ALERT_BUTTON_H: f32 = 22.0;
/// Gap between two action buttons in logical px.
pub const ALERT_BUTTON_GAP: f32 = 6.0;
