...
mod tests {
    ...
    #[test]
    fn mid_tokens_match_middle_size() {
        assert_eq!(ALERT_WIDTH, 315.0);
        assert_eq!(ALERT_TITLE_SIZE, 12.75);
        assert_eq!(ALERT_MESSAGE_SIZE, 11.25);
        assert_eq!(ALERT_BUTTON_H, 33.0);
    }
}
