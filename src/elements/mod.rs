...
pub use toggles::{
    ...
    TOGGLE_ICON_BOX, TOGGLE_ICON_GLYPH, TOGGLE_ICON_RADIUS, TOGGLE_KNOB_EXPAND,
    TOGGLE_KNOB_PAD, TOGGLE_KNOB_W_RATIO, TOGGLE_LABEL_SIZE, TOGGLE_OFF_DARK,
    TOGGLE_OFF_LIGHT, TOGGLE_SNAP_SECONDS, TOGGLE_SWITCH_H, TOGGLE_SWITCH_W,
};
