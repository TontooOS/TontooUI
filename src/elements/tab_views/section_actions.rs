//! TabBarSectionActions — Adds custom actions to a tab section.
...
impl Default for TabBarSectionActions { fn default() -> Self { Self::new() } }

impl ViewContent for TabBarSectionActions {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabBarSectionActions"));
        ...
        let hint = gtk::Label::new(Some("Adds custom actions to a tab section."));
...
impl Widget for TabBarSectionActions {
...
mod tests {
    use super::*;
    #[test]
    fn section_actions_exists() { let _ = TabBarSectionActions::new(); }
}
