//! TabViewSideBarFooter — Adds a custom footer to the sidebar of a tab view.
...
impl Default for TabViewSideBarFooter { fn default() -> Self { Self::new() } }

impl ViewContent for TabViewSideBarFooter {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabViewSideBarFooter"));
        ...
        let hint = gtk::Label::new(Some("Adds a custom footer to the sidebar of"));
...
impl Widget for TabViewSideBarFooter {
...
mod tests {
    use super::*;
    #[test]
    fn side_bar_footer_exists() { let _ = TabViewSideBarFooter::new(); }
}
