...
impl Default for PageTabViewStyle { fn default() -> Self { Self::new() } }

impl ViewContent for PageTabViewStyle {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("PageTabViewStyle"));
...
impl Widget for PageTabViewStyle {
...
mod tests {
    use super::*;
    #[test]
    fn page_style_exists() { let _ = PageTabViewStyle::new(); }
}
