//! BottomAccessory — A modifier to place content above the tabs
...
impl Default for BottomAccessory { fn default() -> Self { Self::new() } }

impl ViewContent for BottomAccessory {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("BottomAccessory"));
        ...
        let hint = gtk::Label::new(Some("A modifier to place content above the "));
...
impl Widget for BottomAccessory {
...
mod tests {
    use super::*;
    #[test]
    fn bottom_accessory_exists() { let _ = BottomAccessory::new(); }
}
