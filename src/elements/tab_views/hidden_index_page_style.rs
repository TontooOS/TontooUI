//! HiddenIndexPageTabViewStyle — A TabViewStyle that displays a paged scrolling TabView with a hidden index.
...
impl Default for HiddenIndexPageTabViewStyle { fn default() -> Self { Self::new() } }

impl ViewContent for HiddenIndexPageTabViewStyle {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("HiddenIndexPageTabViewStyle"));
        ...
        let hint = gtk::Label::new(Some("A TabViewStyle that displays a paged s"));
...
impl Widget for HiddenIndexPageTabViewStyle {
...
mod tests {
    use super::*;
    #[test]
    fn hidden_index_page_style_exists() { let _ = HiddenIndexPageTabViewStyle::new(); }
}
