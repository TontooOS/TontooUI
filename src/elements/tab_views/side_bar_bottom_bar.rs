//! TabViewSideBarBottomBar — Adds a custom bottom bar to the sidebar of a tab view.
...
impl Default for TabViewSideBarBottomBar { fn default() -> Self { Self::new() } }

impl ViewContent for TabViewSideBarBottomBar {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabViewSideBarBottomBar"));
        ...
        let hint = gtk::Label::new(Some("Adds a custom bottom bar to the sideba"));
...
impl Widget for TabViewSideBarBottomBar {
...
mod tests {
    use super::*;
    #[test]
    fn side_bar_bottom_bar_exists() { let _ = TabViewSideBarBottomBar::new(); }
}
