//! DefaultCollapsedTabSection — Sets the default expansion state for the section containing this tab to collapse...
...
impl Default for DefaultCollapsedTabSection { fn default() -> Self { Self::new() } }

impl ViewContent for DefaultCollapsedTabSection {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("DefaultCollapsedTabSection"));
        ...
        let hint = gtk::Label::new(Some("Sets the default expansion state for t"));
...
impl Widget for DefaultCollapsedTabSection {
...
mod tests {
    use super::*;
    #[test]
    fn default_collapsed_section_exists() { let _ = DefaultCollapsedTabSection::new(); }
}
