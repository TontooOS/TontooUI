//! DefaultAdaptableTabBarPlacement — Specifies the default placement for the tabs in a tab view using the adaptable...
...
impl Default for DefaultAdaptableTabBarPlacement { fn default() -> Self { Self::new() } }

impl ViewContent for DefaultAdaptableTabBarPlacement {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("DefaultAdaptableTabBarPlacement"));
        ...
        let hint = gtk::Label::new(Some("Specifies the default placement for th"));
...
impl Widget for DefaultAdaptableTabBarPlacement {
...
mod tests {
    use super::*;
    #[test]
    fn default_adaptable_placement_exists() { let _ = DefaultAdaptableTabBarPlacement::new(); }
}
