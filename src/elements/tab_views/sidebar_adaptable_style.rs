...
impl Default for SidebarAdaptableTabViewStyle { fn default() -> Self { Self::new() } }

impl ViewContent for SidebarAdaptableTabViewStyle {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("SidebarAdaptableTabViewStyle"));
        ...
        let hint = gtk::Label::new(Some("A tab bar style that adapts to each pl"));
...
impl Widget for SidebarAdaptableTabViewStyle {
...
mod tests {
    use super::*;
    #[test]
    fn sidebar_adaptable_style_exists() { let _ = SidebarAdaptableTabViewStyle::new(); }
}
