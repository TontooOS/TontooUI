//! ValueTabView — Creates a tab view that uses a builder to create and specify selection values for...
...
impl Default for ValueTabView { fn default() -> Self { Self::new() } }

impl ViewContent for ValueTabView {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("ValueTabView"));
        ...
        let hint = gtk::Label::new(Some("Creates a tab view that uses a builder"));
...
mod tests {
    use super::*;
    #[test]
    fn value_tab_view_exists() { let _ = ValueTabView::new(); }
}
