//! TabViewSideBarHeader — Adds a custom header to the sidebar of a tab view.
...
impl Default for TabViewSideBarHeader { fn default() -> Self { Self::new() } }

impl ViewContent for TabViewSideBarHeader {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabViewSideBarHeader"));
        ...
        let hint = gtk::Label::new(Some("Adds a custom header to the sidebar of"));
...
impl Widget for TabViewSideBarHeader {
...
mod tests {
    use super::*;
    #[test]
    fn side_bar_header_exists() { let _ = TabViewSideBarHeader::new(); }
}
