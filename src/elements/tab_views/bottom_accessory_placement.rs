//! TabViewBottomAccessoryPlacement — A placement of the bottom accessory in a tab view. You can use this to adjust...
...
/// TabViewBottomAccessoryPlacement — style — A placement of the bottom accessory in a tab view. You can use this to adjust...
...
impl Default for TabViewBottomAccessoryPlacement { fn default() -> Self { Self::new() } }

impl ViewContent for TabViewBottomAccessoryPlacement {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabViewBottomAccessoryPlacement"));
        ...
        let hint = gtk::Label::new(Some("A placement of the bottom accessory in"));
...
impl Widget for TabViewBottomAccessoryPlacement {
...
mod tests {
    use super::*;
    #[test]
    fn bottom_accessory_placement_exists() { let _ = TabViewBottomAccessoryPlacement::new(); }
}
