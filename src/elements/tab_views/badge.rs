//! TabBadge — Generates a badge for a tab from an integer value.
...
impl Default for TabBadge { fn default() -> Self { Self::new() } }

impl ViewContent for TabBadge {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabBadge"));
        ...
        let hint = gtk::Label::new(Some("Generates a badge for a tab from an in"));
...
mod tests {
    use super::*;
    #[test]
    fn badge_exists() { let _ = TabBadge::new(); }
}
