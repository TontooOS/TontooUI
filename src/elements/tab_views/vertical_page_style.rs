...
impl Default for VerticalPageTabViewStyle { fn default() -> Self { Self::new() } }

impl ViewContent for VerticalPageTabViewStyle {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("VerticalPageTabViewStyle"));
        ...
        let hint = gtk::Label::new(Some("A TabViewStyle that displays a vertica"));
...
impl Widget for VerticalPageTabViewStyle {
...
mod tests {
    use super::*;
    #[test]
    fn vertical_page_style_exists() { let _ = VerticalPageTabViewStyle::new(); }
}
