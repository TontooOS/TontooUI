...
impl Default for TabBarOnlyTabViewStyle { fn default() -> Self { Self::new() } }

impl ViewContent for TabBarOnlyTabViewStyle {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabBarOnlyTabViewStyle"));
        ...
        let hint = gtk::Label::new(Some("A tab view style that displays a tab b"));
...
impl Widget for TabBarOnlyTabViewStyle {
...
mod tests {
    use super::*;
    #[test]
    fn tab_bar_only_style_exists() { let _ = TabBarOnlyTabViewStyle::new(); }
}
