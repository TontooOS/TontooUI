//! TabViewCustomization — Specifies the customizations to apply to the sidebar representation of the tab...
...
impl Default for TabViewCustomization { fn default() -> Self { Self::new() } }

impl ViewContent for TabViewCustomization {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("TabViewCustomization"));
        ...
        let hint = gtk::Label::new(Some("Specifies the customizations to apply "));
...
impl Widget for TabViewCustomization {
...
mod tests {
    use super::*;
    #[test]
    fn customization_exists() { let _ = TabViewCustomization::new(); }
}
