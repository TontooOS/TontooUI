...
impl Default for GroupedTabViewStyle { fn default() -> Self { Self::new() } }

impl ViewContent for GroupedTabViewStyle {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        let title = gtk::Label::new(Some("GroupedTabViewStyle"));
...
impl Widget for GroupedTabViewStyle {
...
mod tests {
    use super::*;
    #[test]
    fn grouped_style_exists() { let _ = GroupedTabViewStyle::new(); }
}
