...
| `GLASS_EDGE_WIDTH` / `GLASS_EDGE_WIDTH_LARGE` | 1 px rim band, 2 px once the smaller side reaches `GLASS_LARGE_MIN_SIDE` (200 px) |
...
under it `stroke_backdrop_edge` strokes a 1 px blurred rim (2 px on large glass) fully inside the
