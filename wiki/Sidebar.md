...
| `SIDEBAR_ROW_H` | 48 px item rows |
| `SIDEBAR_PAD` | 16 px sidebar inset |
| `SIDEBAR_ICON_SIZE` / `SIDEBAR_ICON_GAP` | 28 px icon box / 12 px gap |
| `SIDEBAR_LABEL_SIZE` / `SIDEBAR_TITLE_SIZE` | 19 px item labels / 19 px semibold toolbar title |
